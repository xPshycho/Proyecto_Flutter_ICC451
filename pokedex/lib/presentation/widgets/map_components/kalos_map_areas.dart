...
class KalosMapAreas {
  ...
  static List<MapArea> get areas => [
    // Rutas (se aproximan polígonos como rectángulos delimitadores)
    MapArea(name: 'Route 1', rect: Rect.fromLTRB(210, 163, 213, 173)),
    MapArea(name: 'Route 2', rect: Rect.fromLTRB(209, 140, 214, 150)),
    MapArea(name: 'Route 3', rect: Rect.fromLTRB(200, 124, 209, 132)), // polígono -> bbox
    MapArea(name: 'Route 4', rect: Rect.fromLTRB(173, 90, 193, 114)), // polígono -> bbox
    MapArea(name: 'Route 5', rect: Rect.fromLTRB(133, 89, 157, 115)), // polígono -> bbox
    MapArea(name: 'Route 6', rect: Rect.fromLTRB(97, 95, 127, 117)), // polígono -> bbox
    MapArea(name: 'Route 7', rect: Rect.fromLTRB(76, 118, 124, 123)),
    MapArea(name: 'Route 8', rect: Rect.fromLTRB(55, 126, 70, 155)), // polígono -> bbox
    MapArea(name: 'Route 9', rect: Rect.fromLTRB(78, 156, 109, 162)),
    MapArea(name: 'Route 10', rect: Rect.fromLTRB(32, 103, 51, 118)), // polígono -> bbox
    MapArea(name: 'Route 11', rect: Rect.fromLTRB(30, 87, 34, 95)), // polígono -> bbox
    MapArea(name: 'Route 12', rect: Rect.fromLTRB(53, 61, 103, 76)), // polígono -> bbox
    MapArea(name: 'Route 13', rect: Rect.fromLTRB(115, 62, 152, 76)), // polígono -> bbox
    MapArea(name: 'Route 14', rect: Rect.fromLTRB(162, 30, 168, 63)),
    MapArea(name: 'Route 15', rect: Rect.fromLTRB(169, 25, 215, 60)), // polígono -> bbox
    MapArea(name: 'Route 16', rect: Rect.fromLTRB(179, 63, 213, 77)), // polígono -> bbox
    MapArea(name: 'Route 17', rect: Rect.fromLTRB(224, 62, 275, 81)), // polígono -> bbox
    MapArea(name: 'Route 18', rect: Rect.fromLTRB(285, 83, 294, 92)), // polígono -> bbox
    MapArea(name: 'Route 19', rect: Rect.fromLTRB(275, 98, 294, 115)), // polígono -> bbox
    MapArea(name: 'Route 20', rect: Rect.fromLTRB(258, 123, 266, 154)), // polígono -> bbox
    MapArea(name: 'Route 21', rect: Rect.fromLTRB(241, 114, 264, 119)),
    MapArea(name: 'Route 22', rect: Rect.fromLTRB(202, 113, 229, 121)), // polígono -> bbox
    ...
    MapArea(name: 'Azure Bay', rect: Rect.fromLTRB(84, 41, 105, 58)), // polígono -> bbox
