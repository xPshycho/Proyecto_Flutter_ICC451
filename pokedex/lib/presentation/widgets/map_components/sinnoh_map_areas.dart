...
class SinnohMapAreas {
  ...
  static List<MapArea> get areas => [
    ...
    MapArea(name: 'Iron Island', rect: Rect.fromLTRB(22, 66, 30, 74), identifier: 'iron-island'),
    MapArea(name: 'Full Moon Island', rect: Rect.fromLTRB(16, 17, 24, 25), identifier: 'full-moon-island'),
    MapArea(name: 'New Moon Island', rect: Rect.fromLTRB(29, 17, 37, 25), identifier: 'new-moon-island'),
    ...
    MapArea(name: 'Pal Park', rect: Rect.fromLTRB(64, 158, 72, 164), identifier: 'pal-park'),
    MapArea(name: 'Snowpoint City', rect: Rect.fromLTRB(78, 3, 86, 18), identifier: 'snowpoint-city'),
    MapArea(name: 'Lake Acuity', rect: Rect.fromLTRB(64, 6, 76, 18), identifier: 'lake-acuity'),
    MapArea(name: 'Acuity Lakefront', rect: Rect.fromLTRB(64, 3, 77, 18), identifier: 'acuity-lakefront'),
    MapArea(name: 'Celestic Town', rect: Rect.fromLTRB(100, 73, 108, 81), identifier: 'celestic-town'),
    MapArea(name: 'Hearthome City', rect: Rect.fromLTRB(99, 108, 114, 123), identifier: 'hearthome-city'),
    MapArea(name: 'Solaceon Town', rect: Rect.fromLTRB(120, 101, 135, 109), identifier: 'solaceon-town'),
    MapArea(name: 'Veilstone City', rect: Rect.fromLTRB(148, 87, 163, 102), identifier: 'veilstone-city'),
    MapArea(name: 'Sendoff Spring', rect: Rect.fromLTRB(162, 108, 177, 118), identifier: 'sendoff-spring'),
    MapArea(name: 'Spring Path', rect: Rect.fromLTRB(162, 118, 177, 123), identifier: 'spring-path'),
    MapArea(name: 'Lake Valor', rect: Rect.fromLTRB(148, 122, 159, 136), identifier: 'lake-valor'),
    MapArea(name: 'Valor Lakefront', rect: Rect.fromLTRB(159, 122, 163, 136), identifier: 'valor-lakefront'),
    MapArea(name: 'Sunyshore City', rect: Rect.fromLTRB(183, 122, 198, 137), identifier: 'sunyshore-city'),
    MapArea(name: 'Victory Road', rect: Rect.fromLTRB(183, 88, 191, 94), identifier: 'victory-road'),
    MapArea(name: 'Pokémon League', rect: Rect.fromLTRB(183, 80, 191, 88), identifier: 'pokemon-league'),
    MapArea(name: 'Fight Area', rect: Rect.fromLTRB(134, 52, 149, 60), identifier: 'fight-area'),
    MapArea(name: 'Survival Area', rect: Rect.fromLTRB(141, 31, 149, 39), identifier: 'survival-area'),
    MapArea(name: 'Resort Area', rect: Rect.fromLTRB(22, 150, 30, 158), identifier: 'resort-area'),
    MapArea(name: 'Battle Tower / Battle Park', rect: Rect.fromLTRB(141, 45, 149, 52), identifier: 'battle-tower-battle-park'),
    MapArea(name: 'Battle Frontier', rect: Rect.fromLTRB(145, 45, 149, 52), identifier: 'battle-frontier'),
    ...
    MapArea(name: 'Valley Windworks', rect: Rect.fromLTRB(50, 101, 58, 109), identifier: 'valley-windworks'),
    MapArea(name: 'Fuego Ironworks', rect: Rect.fromLTRB(36, 87, 44, 95), identifier: 'fuego-ironworks'),
    MapArea(name: 'Eterna Forest', rect: Rect.fromLTRB(43, 73, 58, 88), identifier: 'eterna-forest'),
    MapArea(name: 'Seabreak Path', rect: Rect.fromLTRB(197, 10, 205, 68), identifier: 'seabreak-path'),
