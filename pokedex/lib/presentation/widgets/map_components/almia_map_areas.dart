...
class AlmiaMapAreas {
  ...
  static List<MapArea> get areas => [
    ...
    MapArea(name: 'Altru Park', rect: Rect.fromLTRB(85, 70, 100, 78), identifier: 'almia-altru-park'),
    MapArea(name: 'Altru Building', rect: Rect.fromLTRB(85, 62, 100, 70), identifier: 'almia-altru-building'),
    MapArea(name: 'Altru Tower', rect: Rect.fromLTRB(92, 34, 100, 43), identifier: 'almia-altru-tower'),
    MapArea(name: 'Peril Cliffs', rect: Rect.fromLTRB(68, 44, 76, 71), identifier: 'almia-peril-cliffs'),
    ...
    MapArea(name: 'Ranger Union', rect: Rect.fromLTRB(44, 70, 52, 78), identifier: 'almia-ranger-union'),
    ...
    MapArea(name: 'Almia Castle', rect: Rect.fromLTRB(15, 30, 23, 39), identifier: 'almia-castle'),
    MapArea(name: 'Chroma Ruins', rect: Rect.fromLTRB(171, 27, 177, 35), identifier: 'chroma-ruins'),
    MapArea(name: 'Chroma Highlands', rect: Rect.fromLTRB(171, 36, 177, 44), identifier: 'almia-chroma-highlands'),
    MapArea(name: 'Boyleland', rect: Rect.fromLTRB(217, 85, 232, 93), identifier: 'almia-boyleland'),
    ...
    MapArea(name: 'Hippowdon Temple', rect: Rect.fromLTRB(232, 150, 238, 158), identifier: 'almia-hippowdon-temple'),
    MapArea(name: 'Oil Field Hideout', rect: Rect.fromLTRB(163, 154, 171, 160), identifier: 'almia-oil-field-hideout'),
    ...
    MapArea(name: 'Capture Arena', rect: Rect.fromLTRB(40, 160, 48, 168), identifier: 'almia-capture-arena'),
    MapArea(name: 'Chicole Path', rect: Rect.fromLTRB(92, 132, 100, 151), identifier: 'almia-chicole-path'),
    MapArea(name: 'School Road', rect: Rect.fromLTRB(100, 124, 120, 132), identifier: 'almia-school-road'),
    MapArea(name: 'Nabiki Beach', rect: Rect.fromLTRB(83, 124, 92, 132), identifier: 'nabiki-beach'),
    MapArea(name: 'Vein Forest', rect: Rect.fromLTRB(92, 86, 100, 117), identifier: 'almia-vein-forest'),
    MapArea(name: 'Union Road', rect: Rect.fromLTRB(52, 70, 85, 78), identifier: 'almia-union-road'),
    MapArea(name: 'Crysta Cave', rect: Rect.fromLTRB(15, 70, 44, 78), identifier: 'crysta-cave'),
    MapArea(name: 'Hia Field', rect: Rect.fromLTRB(15, 39, 23, 70), identifier: 'almia-hia-field'),
    // Chroma Road aparece varias veces; usar un rect que cubra las variantes
    MapArea(name: 'Chroma Road', rect: Rect.fromLTRB(100, 47, 178, 78), identifier: 'almia-chroma-road'),
    MapArea(name: 'Haruba Desert', rect: Rect.fromLTRB(231, 158, 239, 166), identifier: 'almia-haruba-desert'),
  ];
}
