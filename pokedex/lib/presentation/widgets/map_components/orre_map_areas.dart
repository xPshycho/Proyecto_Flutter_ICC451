...
class OrreMapAreas {
  ...
  static List<MapArea> get areas => [
    ...
    MapArea(name: "Kaminko's Laboratory", rect: Rect.fromLTRB(52, 96, 60, 104), identifier: 'kaminkos-laboratory'),
    MapArea(name: 'Orre Colosseum', rect: Rect.fromLTRB(57, 122, 65, 130), identifier: 'orre-colosseum'),
    MapArea(name: 'Oasis PokéSpot', rect: Rect.fromLTRB(73, 90, 81, 96), identifier: 'oasis-pokespot'),
    ...
    MapArea(name: 'Cave PokéSpot', rect: Rect.fromLTRB(114, 70, 122, 76), identifier: 'cave-pokespot'),
    MapArea(name: 'Cipher Lab', rect: Rect.fromLTRB(117, 90, 125, 98), identifier: 'cipher-lab'),
    MapArea(name: 'Realgam Tower', rect: Rect.fromLTRB(118, 110, 126, 118), identifier: 'realgam-tower'),
    MapArea(name: 'Cipher Key Lair', rect: Rect.fromLTRB(130, 34, 138, 42), identifier: 'cipher-key-lair'),
    MapArea(name: 'S.S. Libra', rect: Rect.fromLTRB(151, 74, 159, 82), identifier: 'ss-libra'),
    MapArea(name: 'Rock/Ground PokéSpot', rect: Rect.fromLTRB(180, 79, 188, 85), identifier: 'rock-ground-pokespot'),
    ...
    MapArea(name: 'Outskirt Stand', rect: Rect.fromLTRB(177, 104, 185, 112), identifier: 'outskirt-stand'),
    MapArea(name: 'Snagem Hideout', rect: Rect.fromLTRB(179, 52, 187, 60), identifier: 'snagem-hideout'),
