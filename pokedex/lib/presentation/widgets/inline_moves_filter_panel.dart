...
class InlineMovesFilterPanel extends StatefulWidget {
  final Function(Map<String, dynamic>)? onApplyFilters;
  final Map<String, dynamic>? initialFilters;

  const InlineMovesFilterPanel({
    super.key,
    this.onApplyFilters,
    this.initialFilters,
  });
  ...
  @override
  State<InlineMovesFilterPanel> createState() => _InlineMovesFilterPanelState();
}

class _InlineMovesFilterPanelState extends State<InlineMovesFilterPanel> {
